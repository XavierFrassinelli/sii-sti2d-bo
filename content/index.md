---
title: "Accueil - Programme SII STI2D"
description: "Index des objectifs et compétences du programme SII (BO)"
---

# Programme SII — STI2D

<div class="illustration">🏫 Bienvenue s: Progression STI2D </div>
...
## Les 7 Objectifs de Formation

<div class="illustration">🎯 Parcours d'apprentissage structuré</div>

<div class="objectif-grid">

<div class="objectif-card o1">
<h3>O1 - Caractériser</h3>
...
<div class="illustration">📚 Ressources pédagogiques</div>
...
<div class="illustration">✨ Contenu riche et structuré</div>

## Organisation des contenus

Chaque objectif détaille :
- **Les compétences associées** (CO1.x à CO7.x) avec descriptions complètes
- **Le contenu pédagogique** (notions, principes, outils)
- **Les contextes techniques** (70+ exemples réels : vélo électrique, smartphone, drone, etc.)
- **Les modalités pédagogiques** (5+ méthodes : démontage, brainstorming, simulation...)
- **Les modalités d'évaluation** (rubrics 4 niveaux avec descripteurs explicites)
- **Les ressources et outils** disponibles

---

<div class="illustration">🎓 Pour les enseignants</div>

## Pour les enseignants

Ce portail offre une structure complète basée sur le BO pour :
- Planifier les apprentissages progressifs
- Associer chaque compétence à des activités concrètes
- Évaluer la maîtrise de chaque objectif
- Intégrer des contextes riches et variés
- Développer le potentiel de chaque élève STI2D

**Source :** Bulletin Officiel — Programme SII (STI2D)
